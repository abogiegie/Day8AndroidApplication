    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_picture).setOnClickListener(v -> {
            if (ContextCompat.checkSelfPermission(RecordVideoActivity.this,
                ...
                ActivityCompat.requestPermissions(RecordVideoActivity.this, requestPermission, PackageManager.PERMISSION_GRANTED);
            } else {
                //todo 打开相机拍摄
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_CAMERA: {
                ...
                for(int i = 0; i < size; i++){
                    grantResults[i] = ContextCompat.checkSelfPermission(RecordVideoActivity.this, permissions[i]);
                }
                break;
            }
        }
